    ...
    return (
        <nav className="sticky z-60 top-0 flex flex-col w-full md:w-full p-[1%] md:flex-row">
            ...
            <div id='nav-links' className="hidden md:flex md:w-[50%] justify-evenly items-center">
                <NavLink to="/" className={({isActive})=> isActive ? "text-lg border-b-[3px] border-white focus:border-white shadow-lg focus:text-white focus:outline-none py-1 px-4 rounded-lg hover:text-white" : "text-lg border-b-[3px] border-transparent hover:border-white focus:border-white focus:text-white focus:outline-none py-1 px-4 rounded-lg hover:text-white"} onClick={focusOnElement}>Home</NavLink>
                <NavLink to="/about" className={({isActive})=> isActive ? "text-lg border-b-[3px] border-white focus:border-white shadow-lg focus:text-white focus:outline-none py-1 px-4 rounded-lg hover:text-white" : "text-lg border-b-[3px] border-transparent hover:border-white focus:border-white focus:text-white focus:outline-none py-1 px-4 rounded-lg hover:text-white"} onClick={focusOnElement}>About</NavLink>
                <NavLink to="/posts" className={({isActive})=> isActive ? "text-lg border-b-[3px] border-white focus:border-white shadow-lg focus:text-white focus:outline-none py-1 px-4 rounded-lg hover:text-white" : "text-lg border-b-[3px] border-transparent hover:border-white focus:border-white focus:text-white focus:outline-none py-1 px-4 rounded-lg hover:text-white"} onClick={focusOnElement}>Posts</NavLink>
            </div>
        </nav>
    )
}